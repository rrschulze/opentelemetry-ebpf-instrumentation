...
//go:generate $BPF2GO -cc $BPF_CLANG -cflags $BPF_CFLAGS -type flow_metrics_t -type flow_id_t -type flow_record_t -type packet_count_t -target amd64,arm64,s390x NetSk ../../../../bpf/netolly/flows_sock.c -- -I../../../../bpf
