...
const (
	BpfMapActiveAcceptArgs                                    = "active_accept_args"
	BpfMapActiveConnectArgs                                   = "active_connect_args"
	BpfMapActiveRecvArgs                                      = "active_recv_args"
	BpfMapActiveSendArgs                                      = "active_send_args"
	BpfMapActiveSendSockArgs                                  = "active_send_sock_args"
	...
	BpfMapFilterPorts                                         = "filter_ports"
	...
	BpfMapPidTidToConn                                        = "pid_tid_to_conn"
	...
	BpfMapSockFilterBuffers                                   = "sock_filter_buffers"
	...
	BpfProgObiIterTcp                                         = "obi_iter_tcp"
	BpfProgObiKprobeInetCskListenStop                         = "obi_kprobe_inet_csk_listen_stop"
	BpfProgObiKprobeSecuritySocketAccept                      = "obi_kprobe_security_socket_accept"
	BpfProgObiKprobeSockDefErrorReport                        = "obi_kprobe_sock_def_error_report"
	BpfProgObiKprobeSockRecvmsg                               = "obi_kprobe_sock_recvmsg"
	BpfProgObiKprobeSysConnect                                = "obi_kprobe_sys_connect"
	BpfProgObiKprobeSysExit                                   = "obi_kprobe_sys_exit"
	BpfProgObiKprobeSysIoctl                                  = "obi_kprobe_sys_ioctl"
	BpfProgObiKprobeTcpCleanupRbuf                            = "obi_kprobe_tcp_cleanup_rbuf"
	BpfProgObiKprobeTcpClose                                  = "obi_kprobe_tcp_close"
	BpfProgObiKprobeTcpConnect                                = "obi_kprobe_tcp_connect"
	...
	BpfProgObiKretprobeSockRecvmsg                            = "obi_kretprobe_sock_recvmsg"
	BpfProgObiKretprobeSysAccept4                             = "obi_kretprobe_sys_accept4"
	BpfProgObiKretprobeSysClone                               = "obi_kretprobe_sys_clone"
	...
	BpfProgObiNgxEventConnectPeerRet                          = "obi_ngx_event_connect_peer_ret"
	BpfProgObiNgxHttpUpstreamInit                             = "obi_ngx_http_upstream_init"
	...
	BpfProgObiUprobeSslWriteEx2                               = "obi_uprobe_ssl_write_ex2"
	BpfProgObiUprobeTaskInit                                  = "obi_uprobe_task_init"
	BpfProgObiUprobeTaskInitRet                               = "obi_uprobe_task_init_ret"
	BpfProgObiUprobeTaskStep                                  = "obi_uprobe_task_step"
	BpfProgObiUprobeTaskStepLegacy                            = "obi_uprobe_task_step_legacy"
	BpfProgObiUprobeTaskStepRet                               = "obi_uprobe_task_step_ret"
	BpfProgObiUretprobeContextRun                             = "obi_uretprobe_context_run"
	BpfProgObiUretprobeSslRead                                = "obi_uretprobe_ssl_read"
	BpfProgObiUretprobeSslReadEx                              = "obi_uretprobe_ssl_read_ex"
	BpfProgObiUretprobeSslWrite                               = "obi_uretprobe_ssl_write"
	BpfProgObiUretprobeSslWriteEx                             = "obi_uretprobe_ssl_write_ex"
	BpfProgObiUretprobeSslWriteEx2                            = "obi_uretprobe_ssl_write_ex2"
	BpfProgObiUsdtHotspotMemPoolGcBegin                       = "obi_usdt_hotspot_mem_pool_gc_begin"
	BpfProgObiUsdtHotspotMemPoolGcEnd                         = "obi_usdt_hotspot_mem_pool_gc_end"
	BpfProgObiUvFsAccess                                      = "obi_uv_fs_access"
	BpfVarINVALID_POS                                         = "INVALID_POS"
	BpfVarPUMA_SRV                                            = "PUMA_SRV"
	BpfVarPUMA_SRV_THREAD                                     = "PUMA_SRV_THREAD"
	BpfVarPUMA_WORKER                                         = "PUMA_WORKER"
	BpfVarTP                                                  = "TP"
	...
	BpfVarJvmSamplingIntervalNs                               = "jvm_sampling_interval_ns"
	...
	BpfVarNgxConnectionS_fd                                   = "ngx_connection_s_fd"
	BpfVarNgxConnectionS_sockaddr                             = "ngx_connection_s_sockaddr"
	BpfVarNgxHttpRequestS_conn                                = "ngx_http_request_s_conn"
...
type BpfProgramSpecs struct {
	...
	ObiUprobeSslWriteEx2                               *ebpf.ProgramSpec `ebpf:"obi_uprobe_ssl_write_ex2"`
	ObiUprobeTaskInit                                  *ebpf.ProgramSpec `ebpf:"obi_uprobe_task_init"`
	ObiUprobeTaskInitRet                               *ebpf.ProgramSpec `ebpf:"obi_uprobe_task_init_ret"`
	ObiUprobeTaskStep                                  *ebpf.ProgramSpec `ebpf:"obi_uprobe_task_step"`
	ObiUprobeTaskStepLegacy                            *ebpf.ProgramSpec `ebpf:"obi_uprobe_task_step_legacy"`
	ObiUprobeTaskStepRet                               *ebpf.ProgramSpec `ebpf:"obi_uprobe_task_step_ret"`
	ObiUretprobeContextRun                             *ebpf.ProgramSpec `ebpf:"obi_uretprobe_context_run"`
	...
	ObiUretprobeSslWriteEx2                            *ebpf.ProgramSpec `ebpf:"obi_uretprobe_ssl_write_ex2"`
	ObiUsdtHotspotMemPoolGcBegin                       *ebpf.ProgramSpec `ebpf:"obi_usdt_hotspot_mem_pool_gc_begin"`
	ObiUsdtHotspotMemPoolGcEnd                         *ebpf.ProgramSpec `ebpf:"obi_usdt_hotspot_mem_pool_gc_end"`
...
type BpfPrograms struct {
	...
	ObiUprobeSslWriteEx2                               *ebpf.Program `ebpf:"obi_uprobe_ssl_write_ex2"`
	ObiUprobeTaskInit                                  *ebpf.Program `ebpf:"obi_uprobe_task_init"`
	ObiUprobeTaskInitRet                               *ebpf.Program `ebpf:"obi_uprobe_task_init_ret"`
	ObiUprobeTaskStep                                  *ebpf.Program `ebpf:"obi_uprobe_task_step"`
	ObiUprobeTaskStepLegacy                            *ebpf.Program `ebpf:"obi_uprobe_task_step_legacy"`
	ObiUprobeTaskStepRet                               *ebpf.Program `ebpf:"obi_uprobe_task_step_ret"`
	ObiUretprobeContextRun                             *ebpf.Program `ebpf:"obi_uretprobe_context_run"`
	...
	ObiUretprobeSslWriteEx2                            *ebpf.Program `ebpf:"obi_uretprobe_ssl_write_ex2"`
	ObiUsdtHotspotMemPoolGcBegin                       *ebpf.Program `ebpf:"obi_usdt_hotspot_mem_pool_gc_begin"`
	ObiUsdtHotspotMemPoolGcEnd                         *ebpf.Program `ebpf:"obi_usdt_hotspot_mem_pool_gc_end"`
...
func (p *BpfPrograms) Close() error {
	return _BpfClose(
		...
		p.ObiUprobeSslWriteEx2,
		p.ObiUprobeTaskInit,
		p.ObiUprobeTaskInitRet,
		p.ObiUprobeTaskStep,
		p.ObiUprobeTaskStepLegacy,
		p.ObiUprobeTaskStepRet,
		p.ObiUretprobeContextRun,
		p.ObiUretprobeSslRead,
		p.ObiUretprobeSslReadEx,
		p.ObiUretprobeSslWrite,
		p.ObiUretprobeSslWriteEx,
		p.ObiUretprobeSslWriteEx2,
		p.ObiUsdtHotspotMemPoolGcBegin,
		p.ObiUsdtHotspotMemPoolGcEnd,
		p.ObiUvFsAccess,
	)
}
