...
func LoadBpfIterObjects(obj any, opts *ebpf.CollectionOptions) error {
...
type BpfIterProgramSpecs struct {
	...
	ObiSkIterTcpListen *ebpf.ProgramSpec `ebpf:"obi_sk_iter_tcp_listen"`
}
...
type BpfIterPrograms struct {
	...
	ObiSkIterTcpListen *ebpf.Program `ebpf:"obi_sk_iter_tcp_listen"`
}

func (p *BpfIterPrograms) Close() error {
	return _BpfIterClose(
		p.ObiSkIterTcp,
		p.ObiSkIterTcpListen,
	)
}
